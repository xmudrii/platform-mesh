...
func (_m *MockResolver) Resolve(dc discovery.DiscoveryInterface, rm meta.RESTMapper) ([]byte, error) {
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(discovery.DiscoveryInterface, meta.RESTMapper) ([]byte, error)); ok {
		return rf(dc, rm)
	}
	if rf, ok := ret.Get(0).(func(discovery.DiscoveryInterface, meta.RESTMapper) []byte); ok {
		r0 = rf(dc, rm)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	if rf, ok := ret.Get(1).(func(discovery.DiscoveryInterface, meta.RESTMapper) error); ok {
		r1 = rf(dc, rm)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockResolver_Expecter) Resolve(dc interface{}, rm interface{}) *MockResolver_Resolve_Call {
	return &MockResolver_Resolve_Call{Call: _e.mock.On("Resolve", dc, rm)}
}
...
func (_c *MockResolver_Resolve_Call) Run(run func(dc discovery.DiscoveryInterface, rm meta.RESTMapper)) *MockResolver_Resolve_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(discovery.DiscoveryInterface), args[1].(meta.RESTMapper))
	})
	return _c
}
