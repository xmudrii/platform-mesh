...
func (_m *MockIOHandler) Delete(clusterName string) error {
...
// MockIOHandler_Delete_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Delete'
type MockIOHandler_Delete_Call struct {
	*mock.Call
}

// Delete is a helper method to define mock.On call
//   - clusterName string
func (_e *MockIOHandler_Expecter) Delete(clusterName interface{}) *MockIOHandler_Delete_Call {
	return &MockIOHandler_Delete_Call{Call: _e.mock.On("Delete", clusterName)}
}

func (_c *MockIOHandler_Delete_Call) Run(run func(clusterName string)) *MockIOHandler_Delete_Call {
...
func (_c *MockIOHandler_Delete_Call) Return(_a0 error) *MockIOHandler_Delete_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIOHandler_Delete_Call) RunAndReturn(run func(string) error) *MockIOHandler_Delete_Call {
	_c.Call.Return(run)
	return _c
}
