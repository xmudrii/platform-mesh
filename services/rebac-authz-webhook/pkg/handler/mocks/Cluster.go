...
// GetEventRecorder provides a mock function for the type Cluster
func (_mock *Cluster) GetEventRecorder(name string) events.EventRecorder {
...
// Cluster_GetEventRecorder_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetEventRecorder'
type Cluster_GetEventRecorder_Call struct {
	*mock.Call
}

// GetEventRecorder is a helper method to define mock.On call
//   - name string
func (_e *Cluster_Expecter) GetEventRecorder(name interface{}) *Cluster_GetEventRecorder_Call {
	return &Cluster_GetEventRecorder_Call{Call: _e.mock.On("GetEventRecorder", name)}
}

func (_c *Cluster_GetEventRecorder_Call) Run(run func(name string)) *Cluster_GetEventRecorder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *Cluster_GetEventRecorder_Call) Return(v events.EventRecorder) *Cluster_GetEventRecorder_Call {
	_c.Call.Return(v)
	return _c
}

func (_c *Cluster_GetEventRecorder_Call) RunAndReturn(run func(name string) events.EventRecorder) *Cluster_GetEventRecorder_Call {
	_c.Call.Return(run)
	return _c
}
