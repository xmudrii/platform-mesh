...
require (
	...
	go.platform-mesh.io/subroutines v0.0.0-20260622145940-383b09051f2a
	k8s.io/api v0.35.4
...
require (
	...
	github.com/platform-mesh/golang-commons v0.17.9 // indirect
	github.com/platform-mesh/subroutines v0.4.2 // indirect
