...
func (_c *Client_Apply_Call) Return(_a0 error) *Client_Apply_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Apply_Call) RunAndReturn(run func(context.Context, runtime.ApplyConfiguration, ...client.ApplyOption) error) *Client_Apply_Call {
	_c.Call.Return(run)
	return _c
}
